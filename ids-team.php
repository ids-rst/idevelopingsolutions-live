      ...
      <div class="col-lg-6 pr-40 md-pr-15 md-mb-50">
        <div class="sec-title4">
          ...
          <div class="desc desc-big">
            We are a professional web & mobile app development company that has been delivering enterprise-level
            solutions to businesses around the globe.
          </div>
          <div class="desc">
            We are a team of dedicated developers, designers, and other professionals and working on a variety of
            projects. We work together with other clients and make sure they will get what they want by providing them
            with all the necessary support they need during their project. If you have any type of problem or need
            anything at all, we are here for you in your time of need.
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="sec-title4 mb-30">
          ...
          <div class="desc">
            We are the best at what we do which is a lot. Over the years while working in the IT industry we are
            developing software applications and mobile apps for our clients all over the globe.
          </div>
        </div>
