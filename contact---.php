      ...
      <div class="row">
         ...
         <div class="col-lg-8 pl-70 md-pl-15 contact-form-block">
                  ...
                  <fieldset>
                     <div class="row">
                        ...
                        <div class="col-lg-12 mb-30 col-md-6 col-sm-6">
                           <input class="from-control" type="text" id="phone" name="phone" placeholder="Phone Number" pattern="[0-9]*" minlength="10" maxlength="10" required="">
                           <div class="invalid-feedback">
                     ...
                     <div class="btn-part">
                        <div class="form-group mb-0">
                           <input class="readon learn-more submit send_contact_mail" type="submit" name="send_mail" value="Submit Now">
                        </div>
                     </div>
                  </fieldset>
                </form>
            ...
            <div class="jumbotron emil-sent-failed-message text-center invalid-feedback" style="display:none;">
              <h2 class="display-8 mb-0">soory, something went wrong.</h2>
            </div>
         </div>
      </div>
   </div>
   <div class="map-canvas pt-120 md-pt-80">
      <iframe id="gmap_canvas" src="https://maps.google.com/maps?q=Dalhouise%20road%20pathankot&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org"></a><br>
