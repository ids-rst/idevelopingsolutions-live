<?php include 'header.php';?>
            ...
            <div class="rs-breadcrumbs img5">
                ...
                <div class="breadcrumbs-inner text-center">
                    ...
                    <h1 class="page-title">Pankaj Chouhan</h1>
                    ...
                    <ul>
                        ...
                        <li title="Home">
                            ...
                            <a class="active" href="index.php" target="_blank">Home</a>
                        ...
                        <li title="It Technology"><a class="active" href="index.php" target="_blank">IT Technology</a></li>



                       <li>Pankaj Chouhan</li>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="images-part">
                                    ...
                                    <img src="assets/images/team/style1/pankajchouhan.jpg" alt="pankajchouhan">
                            ...
                            <div class="col-lg-7 sm-pt-30">
                                ...
                                <div class="con-info">
                                    ...
                                    <span class="designation-info">Web Developer</span>

                                    <h2 class="title">Pankaj Chouhan</h2>

                                    <div class="sec-title4 mb-10">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 text-right md-text-left col-md-12">
                                ...
                                <div class="button-wrap">
                                    ...
                                    <a class="readon learn-more" href="contact.php" target="_blank">Get In Touch</a>
