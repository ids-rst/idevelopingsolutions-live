    ...
    <div class="row align-items-center">
      <div class="col-lg-6 pr-40 md-pr-15 md-mb-50">
        <div class="sec-title4">
          ...
          <h2 class="title">The Web is our medium and we are the professionals who create impactful, creative work.</h2>
          <div class="heading-line custom-line"></div>
          <div class="desc desc-big">
            We are a highly skilled and mature tech company with a highly educated, skilled, and a dedicated team of developers who are experts in their field.
          </div>
          <div class="desc">
            We have a team of expert developers, who can turn your ideas into reality and help you create something remarkable. We use the latest technologies, methodologies, and design principles so that you can find solutions that match your needs. We offer a range of services including website design and development for your businesses.
          </div>
      ...
      <div class="col-lg-6">
        <div class="software-img">
          <img src="assets/images/about/about-us/web-development.jpg" alt="images">
        </div>
      </div>
    </div>
  </div>
