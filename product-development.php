    ...
    <div class="row align-items-center">
      <div class="col-lg-6 pr-40 md-pr-15 md-mb-50">
        <div class="sec-title4">
          <span class="sub-text">Product Development</span>

          <h2 class="title">We help you to Develop, Launch and Manage high-performance Products</h2>

          <div class="heading-line custom-line"></div>

          <div class="desc desc-big">
            We are a leading provider of software solutions that help our customers to create high-performance products.
          </div>

          <div class="desc">
            We help companies to develop outstanding products in the digital age, an internationally operating company that provides consulting, research and development services in the field of digital transformation. We are specialists in
            building digital products and services which engage customers, promote growth and improve business results.
          </div>
      ...
      <div class="col-lg-6">
        <div class="software-img">
          <img src="assets/images/services/100.jpg" alt="images" />
        </div>
      </div>
    </div>
  </div>
